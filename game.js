...
function updateGameArea() {
    if (hasColision()) {
        ...
        alert('O artigo 193 do CTB, proíbe qualquer tipo de tráfego em acostamento. Com isso, a infração por andar nele é gravíssima, no valor de R$293,47 e gera sete pontos na CNH.')
    } else {
        game.clear();
        game.frameNo += 1;
